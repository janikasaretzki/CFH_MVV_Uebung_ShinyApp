...
Wie auch in der Vorlesung sind die Themen den großen Gruppen **Lineare gemischte Modelle (LMM), Gruppierung (G) und Multivariate (latente) Modellierung (MLM)** zugeordnet. Jeder Teil beginnt mit einem kurzen Intro, das die wichtigsten Konzepte einführt, und ist entsprechend im Menü gekennzeichnet. So behalten Sie den Überblick und können gezielt in die Themen einsteigen, die für Ihr Portfolio oder Ihre Interessen besonders relevant sind.
